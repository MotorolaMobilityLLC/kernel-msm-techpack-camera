	...
	struct cam_sensor_power_ctrl_t *power_info, bool regulator_enable)
{
	...
	power_info->power_setting = kzalloc(sizeof(struct cam_sensor_power_setting),	GFP_KERNEL);
	...
	power_info->power_down_setting =	kzalloc(sizeof(struct cam_sensor_power_setting), GFP_KERNEL);
